...
const weapons: readonly Weapon[] = [
  ...
  { type: 'SMG', ammoType: 'Light', name: 'Alternator SMG', isAirdrop: true, isArenaStart: false },
  ...
  { type: 'Marksman', ammoType: 'Sniper', name: 'Triple Take', isAirdrop: true, isArenaStart: false },

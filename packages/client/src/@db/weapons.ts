...
export const weapons: readonly Weapon[] = [
  ...
  { type: 'LMG', ammoType: 'Light', name: 'M600 Spitfire', isAirdrop: false, isArenaStart: false },
  { type: 'LMG', ammoType: 'Heavy', name: 'Rampage LMG', isAirdrop: true, isArenaStart: false },
  ...
  { type: 'Marksman', ammoType: 'Arrows', name: 'Bocek Compound Bow', isAirdrop: true, isArenaStart: false },
  ...
  { type: 'Shotgun', ammoType: 'Shotgun', name: 'Mastiff Shotgun', isAirdrop: true, isArenaStart: false },
  ...
  { type: 'Pistol', ammoType: 'Sniper', name: 'Wingman', isAirdrop: false, isArenaStart: false },

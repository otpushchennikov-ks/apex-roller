...
export const weapons: readonly Weapon[] = [
  ...
  { type: 'SMG', ammoType: 'Light', name: 'RE-45 Auto', isAirdrop: true, isArenaStart: false },
  ...
  { type: 'Marksman', ammoType: 'Energy', name: 'Triple Take', isAirdrop: false, isArenaStart: false },

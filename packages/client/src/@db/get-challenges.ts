import { selectFromMultiplePools, selectRandom } from '@utils';
import { weapons, NumberSetting, BooleanSetting, makeChallenge } from '@db';
...
export const getChallenges = (mode?: string) => !mode ? challenges : challenges.filter(challenge => challenge.mode === mode);

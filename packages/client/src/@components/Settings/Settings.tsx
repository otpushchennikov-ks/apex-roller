...
import { padding, margin, RootStyled, ColumnStyled, RowStyled } from '@styled';
import { GlobalStateContext } from '@context/GlobalState';
import { audioPlayer } from '@modules';
import { SwipeableDrawer, Button, Checkbox, Slider, Select, MenuItem, FormControlLabel, Tooltip } from '@material-ui/core';
import { PlayCircleOutline, ReplayOutlined, SettingsOutlined } from '@material-ui/icons';
import { range } from 'ramda';


export const Settings: FC = () => {
  const { settings, setSettings, mode } = useContext(GlobalStateContext);
